...
import { FaBolt, FaCopy, FaCheck, FaSearch } from 'react-icons/fa'
          ...
          {result && visualization ? (
            <>
              <div className="bg-gray-900 rounded-2xl p-4 border border-gray-800 flex flex-wrap items-center gap-3">
                ...
                <span className="text-xs text-gray-500">· {result.steps.length} steps</span>
                <span className="text-xs text-gray-500">· source {result.meta?.source}</span>
                <button
                  onClick={exportJson}
              ...
              <div className="bg-gray-900 rounded-2xl p-5 border border-gray-800 min-h-[520px]">
                <VisualizationEngine
                  key={runId}
