...
import { FaEnvelope, FaLock, FaRocket, FaCode, FaBrain, FaChartLine } from 'react-icons/fa'
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-[#0B1120] to-gray-900 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-orange-600 to-red-600 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-1">AI-Powered Analysis</h3>
                <p className="text-orange-100">Deep problem analysis with pattern recognition and optimal solutions</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-1">Visual Learning</h3>
                <p className="text-orange-100">See algorithms come to life with step-by-step animations</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-orange-100">Monitor your growth with detailed analytics and insights</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          className="relative z-10 text-orange-100"
        >
          <p className="text-sm">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              {errors.email && (
                <p id="login-email-err" className="mt-1 text-sm text-red-400" role="alert">{errors.email}</p>
              )}
            </div>
            ...
            <div>
              ...
              {errors.password && (
                <p id="login-password-err" className="mt-1 text-sm text-red-400" role="alert">{errors.password}</p>
              )}
            </div>
            ...
            <div className="flex items-center justify-between text-sm">
              <label htmlFor="login-remember" className="flex items-center text-gray-400 cursor-pointer">
                <input
                  id="login-remember"
                  type="checkbox"
                  className="mr-2 w-4 h-4 rounded border-gray-700 bg-gray-900 text-orange-500 focus:ring-orange-500 focus:ring-offset-gray-950"
                />
                Remember me
              </label>
              <Link
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#0B1120] text-gray-400">Or continue with</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className="py-3 px-4 bg-gray-900 border border-gray-700 rounded-xl text-white hover:bg-gray-800 transition-colors flex items-center justify-center gap-2 focus-visible:ring-2 focus-visible:ring-orange-500"
            >
